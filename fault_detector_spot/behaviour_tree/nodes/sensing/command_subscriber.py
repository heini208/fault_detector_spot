...
class CommandSubscriber(py_trees.behaviour.Behaviour):
    ...
    def update(self) -> py_trees.common.Status:
        if self.blackboard.last_command_received is not None:
            self.feedback_message = f"Last received command: {self.blackboard.last_command_received.id}"
        else:
    ...
    def _tag_command_callback(self, msg: TagElement):
        ...
        try:
            ...
            self.blackboard.last_command_received = last_command
    ...
    def is_last_command(self, msg) -> bool:
        if self.blackboard.last_command_received is None:
            return False
        ...
        if stamp is None:
            ...
            return False
        last_stamp = self.blackboard.last_command_received.stamp
