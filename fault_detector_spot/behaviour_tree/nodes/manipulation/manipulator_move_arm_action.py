...
class ManipulatorMoveArmAction(ActionClientBehaviour):
    ...
    def __init__(self,
        ...
        self.blackboard.register_key(key="manipulator_goal_pose", access=Access.READ)
    ...
    def _build_goal(self) -> RobotCommand.Goal:
        ...
        target: PoseStamped = self.blackboard.manipulator_goal_pose
        if target is None:
            raise RuntimeError("No manipulator_goal_pose on blackboard")
