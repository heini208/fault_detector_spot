...
def make_map() -> MapDefinition:
    return MapDefinition(
        ...
        localization_landmarks=[LocalizationLandmark(
            landmark_id="Tag_23",
            display_name="Tag 23",
            reference_tag=ReferenceTag(tag_id=23, tag_family="36h11"),
            pose_map=PoseData.identity(),
...
def test_object_repository_appends_probe_points_without_overwrite(tmp_path):
    repository = ObjectRepository(tmp_path)
    ...
    routine.reference_views = [ReferenceView(
        ...
        reference_dataset_path="reference_datasets/magnetic_scan/set_1/slot1_hand",
        view_id="slot1_hand",
        camera_id="hand",
        slot_index=0,
    )]
